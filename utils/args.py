...
def parse_args(args_list=None):
    ...
    parser.add_argument(
        '--model',
        choices=['LTFed'],
        help='model to use, possible: LTFed',
        default='LTFed'
    )
    parser.add_argument(
        "--random_ring_proba",
    ...
    parser.add_argument(
        '--num_previous_frames',
        help='the number of previous frames;',
        type=int,
        default=10
    )
    parser.add_argument(
        '--test_method',
        choices=['use_ground-truth', 'use_prediction'],
        help='test method to use, possible: use_ground-truth, use_prediction',
        default='use_ground-truth'
    )
    if args_list:
